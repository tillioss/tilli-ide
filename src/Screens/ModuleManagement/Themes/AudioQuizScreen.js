  ...
  return (
    <React.Fragment>
      <div className={"row " + (deviceHeight < 640 ? "pt-2 " : "pt-4")}>
        ...
        {viewType === "answer" || viewType === "onrecord" ? (
          <React.Fragment>
            ...
            >
              <div
                className={"record-font pl-1"}
                dangerouslySetInnerHTML={{
                  __html: data.content.feelingsDataList[
                    index_value
                  ].questions.replace("strong", "span"),
                }}
              />
            </div>
          </React.Fragment>
        ...
        <div
          className="col-11 audio-scroll"
          style={{
            height: deviceHeight > 750 ? 230 : (deviceHeight * 0.9) / 2.7,
            width: 327,
            marginLeft: 32,
            marginRight: 16,
            backgroundColor: data.content.changeColorBox
              ? data.content.changeColorBox
              : bg_color,
            borderWidth: 2,
            borderColor: "#18191F",
        ...
        >
          ...
          {viewType === "question" ? (
            <p className={"audio-font " + (matchString ? "lego-font" : "")}>
              <div
                dangerouslySetInnerHTML={{
                  __html: data.content.feelingsDataList[index_value].questions,
                }}
              />
            </p>
          ) : (
            <React.Fragment>
              <div
                className="row ml-0 audio-scroll"
                style={{
                  height: 150,
                  width: "100%",
      ...
      {viewType === "question" ? (
        <React.Fragment>
          {SupportedBrowser ? (
            <div className="record-text" style={{ color: "red", fontSize: 14 }}>
              {return_content(1, 4)}
            </div>
          ) : (
            <div className="record-text">{return_content(1, 2)}</div>
          )}
        ...
        >
          {viewType === "question" ? (
            ...
            <React.Fragment>
              ...
              >
                {" "}
                <p style={{ fontSize: deviceHeight < 570 ? 10 : 12 }}>
                  {this.return_content(1, 7)}
                </p>
                <Link className="col-2">
                  <img
                    src={
                      viewType === "answer"
                        ? outlineIconOnlyImage
                        : outlineIconRedImage
                    }
                    style={{ width: 60, height: 60 }}
                    alt="loading"
    ...
    if (this.props.themeType === "StoryCard") {
      if (data.content.image) {
        imagePath =
          ...
          data.content.image.json.fileName +
          "&id=" +
          data.content.image.json.fileType;
      } else {
        ...
        {viewType === "question" ? (
          <React.Fragment>
            {SupportedBrowser ? (
              ...
              <div className="record-text">{this.return_content(1, 2)}</div>
            )}
            ...
            {SupportedBrowser ? (
              ...
              <>
                <AudioRecognize1
                  ...
                  returnButtonContent={this.returnButtonContent}
