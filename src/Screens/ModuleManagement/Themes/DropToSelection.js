    ...
    render() {
        ...
        return (<React.Fragment>
            ...
            <div style={{ width: '100%', backgroundColor: modelContent ? "#d5d5d5" : "", height: modelContent ? "100vh" : "" }}>
                ...
                <div id="drop_zone" onDrop={(event) => { this.drop(event) }} onDragOver={(event) => { this.allowDrop(event) }} style={{
                    backgroundColor: content.circles[2].color,
                    height: UWPview ? innerWidth * 0.7 : innerWidth * 0.8,
                    width: UWPview ? "70%" : Orientation ? innerWidth * 0.8 : "80%", marginLeft: UWPview ? "17%" : Orientation ? "10%" : "5%", marginTop: Orientation ? "1%" : "3%", borderRadius: 100000,
                }}>
